...
class Vendor(models.Model):
    managername = EncryptedTextField(default='Anonymous')
    vendorname = EncryptedTextField(default='Anonymous')
    joiningdate = models.DateField(auto_now_add=True)
    address = EncryptedTextField(default='Anonymous')
    vendorcontact = EncryptedIntegerField(validators=[MinValueValidator(0), MaxValueValidator(9999999999)])
